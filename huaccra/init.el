...
(setq user-mail-address "huaccra@gmail.com")
(setq user-full-name "Pavel David Sulca Cavero")
...
(defun color-theme-ruby ()
  ...
  (color-theme-install
   '(color-theme-helvetica
     ...
     (font-lock-constant-face ((t (:bold t :foreground "cornflower blue" :weight bold))))
     (font-lock-doc-face ((t (:italic t :slant italic :foreground "#6688ee"))))
     (font-lock-doc-string-face ((t (:foreground "#6688ee"))))
     (font-lock-function-name-face ((t (:bold t :foreground "skyblue1" :weight bold))))
     (font-lock-keyword-face ((t (:foreground "orange1"))))
     (font-lock-preprocessor-face ((t (:foreground "#6688ee"))))
     (font-lock-reference-face ((t (:foreground "#c2cff1"))))
     (font-lock-string-face ((t (:italic t :foreground "olivedrab2" :slant italic))))
     (font-lock-type-face ((t (:bold t :foreground "mediumorchid1" :weight bold))))
     (font-lock-variable-name-face ((t (:italic t :bold t :foreground "lightgoldenrod1" :slant italic :weight bold))))
     (font-lock-warning-face ((t (:bold t :foreground "IndianRed" :weight bold))))
     (fringe ((t (:background "#444444"))))
     (gnus-cite-attribution-face ((t (:family "Helvetica Neue"))))
     (gnus-cite-face-1 ((t (:foreground "DarkGoldenrod3"))))
